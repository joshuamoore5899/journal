  ...
  <div class="modal-mask">
    <div class="modal-container">
      <form class="pure-form" @submit.prevent="upload">
        ...
        <fieldset>
          Type an emotion that describes your day!
          <input v-model="title" placeholder="Emotion">
        </fieldset>
        <fieldset>
          Write about your day! What did you do? What did you learn? What are your goals for tomorrow?
          <textarea v-model="description" placeholder="Journal Entry"></textarea>
        </fieldset>
        <fieldset>
          <div class="imageInput" @click="chooseImage">
            <img v-if="url" :src="url" />
            <div v-if="!url" class="placeholder">
              Choose an image that represents your day!
            </div>
